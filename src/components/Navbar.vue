<template>
  <nav
    class="flex flex-col items-center w-100% h-full overflow-hidden text-gray-400 bg-gray-900 rounded"
  >
    ...
    <div class="w-full px-2">
      <div class="flex flex-col items-center w-full mt-3 border-t border-gray-700">
        ...
        >
          ...
          <span class="ml-2 text-sm font-medium">Absen</span>
        </router-link>
        <router-link
          to="/docs"
          class="flex items-center w-full h-12 px-3 mt-2 rounded hover:bg-gray-700 hover:text-gray-300"
      ...
      <div class="flex flex-col items-center w-full mt-2 border-t border-gray-700">
        ...
        >
          ...
          <span class="ml-2 text-sm font-medium">Chatbot</span>
